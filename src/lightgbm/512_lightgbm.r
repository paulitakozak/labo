...
modelo  <- lgb.train( data= dtrain,
                      param= list( objective=        "binary",
                                   max_bin=             31,
                                   learning_rate=        0.0912437721734428,
                                   num_iterations=      81,
                                   num_leaves=          405,
                                   feature_fraction=     0.518380134098527,
                                   min_data_in_leaf=  5574,
                                   seed=            999983 )  )
...
archivo_salida  <- "./labo/exp/KA2512/KA_512_001_1.csv"
...
archivo_importancia  <- "./labo/exp/KA2512/512_importancia_001_1.txt"

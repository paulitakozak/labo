...
ksemilla_azar  <- 703411   #cambiar por la primer semilla
...
dir.create( "C:/Lab_Imp_1/labo/exp/",  showWarnings = FALSE ) 
dir.create( "C:/Lab_Imp_1/labo/exp/HT3220/", showWarnings = FALSE )
setwd("C:/Lab_Imp_1/labo/exp/HT3320/")   #Establezco el Working Directory DEL EXPERIMENTO

...
dtrain  <- fread("paquete_premium_202011.csv")
...
dapply  <- fread("paquete_premium_202101.csv")
...
dir.create( "C:/Lab_Imp_1/labo/exp/" ) 
dir.create( "C:/Lab_Imp_1/labo/exp/KA2001" ) 

fwrite( entrega, 
        file= "C:/Lab_Imp_1/labo/exp/KA2001/K101_001_2.csv", 
        sep= "," )

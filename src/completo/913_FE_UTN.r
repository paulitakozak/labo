...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , consumos         := mcaja_ahorro+mtarjeta_visa_consumo ]
  dataset[ , ctas_mov         := mcuentas_saldo / ctrx_quarter ]
  dataset[ , acred_mov         := cpayroll_trx / ctrx_quarter ]
  dataset[ , pf_antig         := cplazo_fijo / cliente_antiguedad ]

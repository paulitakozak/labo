...
param  <- list( "num.trees"=       183,  #cantidad de arboles
                "mtry"=             8,  #cantidad de variables que evalua para hacer un split  sqrt(ncol(dtrain))
                "min.node.size"=  101,  #tamaño minimo de las hojas
                "max.depth"=        9   # 0 significa profundidad infinita
              )

set.seed(703411) #Establezco la semilla aleatoria
...
archivo_salida  <- "./labo/exp/KA2411/KA_411_1_001.csv"
